...
const trendingSearches = [
  'Nike ayakkabı', 'iPhone kılıf', 'Retro ceket', 'Kozmetik seti',
  'Keten pantolon', 'Spor çanta', 'Kadın elbise', 'Oyuncu kulaklığı',
];
      ...
      <View style={{ backgroundColor: pal.card, paddingHorizontal: 16, paddingBottom: 12, paddingTop: 10, borderBottomWidth: 1, borderBottomColor: pal.border }}>
        ...
        <View style={{ flexDirection: 'row', gap: 8, marginTop: 10 }}>
          ...
          >
            ...
            <Text style={{ fontFamily: fonts.medium, fontSize: 12, color: pal.textPrimary }}>Satıcıları Keşfet</Text>
          </Pressable>
          {cartItemCount > 0 && (
            <Pressable
        ...
        <View style={{ backgroundColor: pal.card, paddingVertical: 10, borderBottomWidth: 1, borderBottomColor: pal.border }}>
          <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={{ paddingHorizontal: 14, gap: 8 }}>
            <View style={{ flexDirection: 'row', alignItems: 'center', gap: 5, marginRight: 4 }}>
              ...
              <Text style={{ fontFamily: fonts.bold, fontSize: 10, color: '#EF4444', textTransform: 'uppercase', letterSpacing: 0.5 }}>Popüler</Text>
            </View>
          ...
          >
            {heroBanners.map((banner) => (
              <Pressable
                key={banner.id}
                onPress={() => {
                  if (banner.id === 'campaign-instant') { focusProductTab('flash'); return; }

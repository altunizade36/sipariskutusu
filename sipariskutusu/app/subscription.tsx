...
const PLAN_INFO: PlanInfo[] = [
  {
    ...
    extras: ['Instagram içe aktarma sınırsız'],
  },
  {
    key: 'starter',
    label: 'Başlangıç',
  ...
  },
  {
    ...
    extras: ['Instagram içe aktarma sınırsız', 'Temel mağaza istatistikleri'],
  },
  {
    key: 'pro',
    label: 'Profesyonel',
    ...
    extras: ['Instagram içe aktarma sınırsız', 'Gelişmiş istatistikler', 'Profesyonel Satıcı Rozeti'],
  },
  {
    key: 'elite',
    label: 'Elit',
    ...
    extras: ['Instagram içe aktarma sınırsız', 'Gelişmiş istatistikler', 'Elit Satıcı Rozeti', 'Ana Sayfa Vitrin Hakkı', 'En yüksek öncelik'],
  },
];
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: palette.bg }} edges={['top']}>
      ...
      <View style={{ backgroundColor: colors.primary, paddingHorizontal: 16, paddingTop: 14, paddingBottom: 20, flexDirection: 'row', alignItems: 'center', gap: 12 }}>
        ...
        <View style={{ flex: 1 }}>
          ...
          <Text style={{ fontFamily: fonts.regular, fontSize: 12, color: '#BFDBFE', marginTop: 2 }}>Abonelik ve hak yönetimi</Text>
        </View>
      </View>

...
const slides: {
...
}[] = [
  {
    ...
    description: 'Instagram satıcıları ve alıcıları sosyal alışveriş deneyiminde buluşuyor.',
    feature1: '✓  Onaylı satıcılar',
    feature2: '✓  Sosyal mesajlaşma',
  ...
  },
  {
    ...
    variant: 'success',
    title: 'Sosyal\nAlışverişe Başla 🚀',
    description: 'BO seni bekliyor — Instagram mağazalarını keşfet, satıcılarla doğrudan buluş.',
    feature1: '✓  Instagram mağaza keşfi',

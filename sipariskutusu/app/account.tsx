...
const SUPPORT_EMAIL = 'iletisim@siparişkutusu.com';
const VACATION_KEY = '@siparişkutusu/store_vacation_mode';
...
export default function AccountScreen() {
  ...
  async function handleConfirmSignOut() {
    ...
    try {
      ...
      showToast(err instanceof Error ? err.message : 'Çıkış yapılamadı.');
    } finally {
      setLogoutBusy(false);
    }
  }
